...
const SortableItem = (props) => {
    const bgColor = props.value[0] === '7' ? 'bg-red-100' : 'bg-cyan-100';

    return (
        <div className={`max-w-2xl h-fit text-center rtl ${bgColor} m-2 p-2 rounded-xl select-none flex flex-row justify-between`}>
